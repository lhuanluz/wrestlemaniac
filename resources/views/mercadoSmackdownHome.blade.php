            ...
            <div class="row">
                @foreach($superstars as $superstar)
                    ...
                    <div class="col-md-3 your-team">
                        ...
                        <form id="vender{{$superstar->name}}" class="lutador-info" action="{{route('venderSuperstarSmackdown')}}" method="post">
                            {{ csrf_field()  }}
            ...
            <div class="row"> <!-- MARKET INFO -->
                <div class="market-info col-md-9">
                    <ul>
                        <li>
                            <p>Total Cash</p> 
                            <p>$ {{$smackdownTeam->team_cash + $precoASerAbatido}}</p>
                        </li> 
                        <li class="divisor"></li> 
                        <li>
                            <p>Cash Available</p> 
                            <p>$ {{$smackdownTeam->team_cash}}</p>
                        </li> 
                        <li class="divisor"></li> 
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-12">
                                        <ul>
                                            ...
                                            <li>
                                                @if(Auth::user())
                                                    <form id="comprar{{$superstar->name}}" class="lutador-info" action="{{route('comprarSuperstarSmackdown')}}" method="post">
                                                        {{ csrf_field()  }}
                                                    <input type="hidden" name="name" value="{{$superstar->name}}"/>
